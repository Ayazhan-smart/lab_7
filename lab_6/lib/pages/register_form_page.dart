  ...
  class RegisterFormPage extends StatefulWidget {
    const RegisterFormPage({super.key, required void Function(String n, String d, String p, String e, String c) onSubmit});
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'register_form'.tr(),
                            style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 195, 82, 215)),
                          ),
